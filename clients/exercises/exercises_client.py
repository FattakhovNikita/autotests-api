...
from clients.exercises.exercises_schema import GetExerciseResponseSchema, \
    UpdateExerciseResponseSchema, UpdateExerciseRequestSchema, CreateExerciseResponseSchema, \
    CreateExerciseRequestSchema, GetExercisesQuerySchema, GetExercisesResponseSchema
